...
OpenTelemetry New Relic Exporter Starter is a starter package that includes the opentelemetry-api, opentelemetry-sdk, opentelemetry-auto-annotations, opentelmetry-logging-exporter, opentelemetry-spring-boot-autoconfigurations and spring framework starters required to setup distributed tracing. It also provides the opentelemetry-exporters-newrelic artifact and corresponding exporter auto-configuration.  Check out [opentelemetry-spring-boot-autoconfigure](../../spring-boot-autoconfigure/README.md#features) for the list of supported libraries and features.
...
<dependencies>
  ...
  <dependency>
    ...
    <artifactId>opentelemetry-newrelic-exporter-starter</artifactId>
...
```groovy
implementation 'io.opentelemetry.instrumentation:opentelemetry-newrelic-exporter-starter:OPENTELEMETRY_VERSION'
```
